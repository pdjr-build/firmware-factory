...
#define GPIO_INSTANCE_BIT0 14
#define GPIO_INSTANCE_BIT1 15
#define GPIO_INSTANCE_BIT2 16
#define GPIO_INSTANCE_BIT3 17
#define GPIO_INSTANCE_BIT4 18
#define GPIO_INSTANCE_BIT5 19
#define GPIO_INSTANCE_BIT6 20
...
#define GPIO_SENSOR_RTD 24
#define GPIO_SENSOR_RTG 0
#define GPIO_SWITCH_ENABLE 12
#define GPIO_INPUT_PINS { GPIO_SENSOR_DPD, GPIO_SENSOR_DPG, GPIO_SENSOR_OVL, GPIO_SENSOR_ROT, GPIO_SENSOR_RTD, GPIO_SENSOR_RTG }
#define GPIO_OUTPUT_PINS { GPIO_LED_BOARD, GPIO_LED_DOWN, GPIO_LED_PWR, GPIO_LED_UP, GPIO_RELAY_DOWN, GPIO_RELAY_UP }
...
int SWITCHES[] = { GPIO_SENSOR_ROT, GPIO_SENSOR_RTD, GPIO_SENSOR_DPD, GPIO_SENSOR_DPG, GPIO_SENSOR_RTG };
...
void setRelayOutput(int action, long timeout) {
  switch (action) {
    case 0: // Set relays OFF
      ...
      digitalWrite(GPIO_RELAY_UP, LOW);
      digitalWrite(GPIO_RELAY_DOWN, LOW);
      N2K_LAST_COMMAND = N2kDD484_Off;
      break;
    case -1: // Set relays for RETRIEVE
      commandTimeout(timeout);
      digitalWrite(GPIO_RELAY_UP, HIGH);
      digitalWrite(GPIO_RELAY_DOWN, LOW);
    ...
    case +1: // Set relays for DEPLOY
      commandTimeout(timeout);
      digitalWrite(GPIO_RELAY_UP, LOW);
      digitalWrite(GPIO_RELAY_DOWN, HIGH);
